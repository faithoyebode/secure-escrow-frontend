        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm">
              Secure transactions for buyers and sellers with our trusted escrow service.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/careers" className="text-gray-500 hover:text-gray-900 text-sm">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/how-it-works" className="text-gray-500 hover:text-gray-900 text-sm">
                  How It Works
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/support" className="text-gray-500 hover:text-gray-900 text-sm">
                  Support
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/security" className="text-gray-500 hover:text-gray-900 text-sm">
                  Security
                </Link>
              </li>
            </ul>
